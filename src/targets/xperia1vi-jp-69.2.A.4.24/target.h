...
/*
 * Xperia 1 VI (XQ-EC44 / PDX245) — Sony firmware 69.2.A.4.24 (JP)
 * SoC: SM8650 (Snapdragon 8 Gen 3)
 * Kernel: 6.1.138-android14-11-g0c3d559bcd85-ab14529422
 *
 * Symbol offsets: extracted from embedded kallsyms (101742 symbols).
 * Struct offsets: verified via embedded BTF — identical to GKI 6.1.162.
 * Derived pointers: verified by reading kernel image binary.
 *
 * Note: copy_splice_read does not exist in 6.1.138; COPY_SPLICE_READ
 * points to generic_file_splice_read which serves the same role.
 */

#if defined(APP_PAYLOAD) && APP_PAYLOAD
#define BUILD_VARIANT_LABEL \
  "xperia1vi-jp-69.2.A.4.24-app"
...
#else
#define BUILD_VARIANT_LABEL "xperia1vi-jp-69.2.A.4.24-root-umh"
#endif

#ifndef BUILD_FINGERPRINT
#define BUILD_FINGERPRINT \
  "Sony/XQ-EC44/XQ-EC44:16/69.2.A.4.24/" \
  "069002A004024000000000000:user/release-keys"
#endif
...
#define P0_FINGERPRINT_HEADER \
  "targets/xperia1vi-jp-69.2.A.4.24/p0_fingerprint.h"
#endif
...
#define SLIDE_NFULNL_LOGGER_NAME_OFF 0x01511d48ULL
#define SLIDE_NFULNL_LOGGER_OBJECT_OFF 0x01fe29c8ULL
#define SLIDE_RB_PARENT_TYPE_RESTORE 1ULL
#define SLIDE_RANDOM_TABLE_BOOT_ID_DATA_PTR_OFF 0x02107448ULL
